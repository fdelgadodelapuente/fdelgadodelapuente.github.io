...
def cmdLineParse():
    ...
    ###parser.add_argument('-xe','--XEMTFILE', dest='XEMTFILE', type=str,
    ###        required=True, help='XEMTFILE')
    ###parser.add_argument('-xm','--XMLFILE', dest='XMLFILE', type=str,
    ###        required=True, help='XMLFILE')
...
def unpack(fname, slcname):
    ...
    print(os.path.join(fname,'S1*/Data/slc*-hh'))
...
if __name__ == '__main__':
    ...
    ####if inps.XEMTFILE.endswith('/'):
    ####    inps.XEMTFILE = inps.h5dir[:-1]

    ####if inps.XMLFILE.endswith('/'):
    ####    inps.XMLFILE = inps.h5dir[:-1]
