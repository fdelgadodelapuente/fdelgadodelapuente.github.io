...
The compilation shows six different mechanisms of ground deformation. These are: 1) co-eruptive deflation during eruptions (Chaiten, Cordon Caulle, Calbuco), 2) continuous inflation due to magma injection and/or viscoelastic relaxation after Plinian/sub-Plinian eruptions (Hudson, Cordon Caulle), 3) near continuous injection of magma (Laguna del Maule), 4) an episode of trasient, short-lived uplift after the 2015 VEI 2 eruption of Villarrica volcano, 5) secular deflation due to hydrothermal activity/intrusion crystallization interrupted by transient episodes of magma injection lasting 2.5-8 years (Copahue and Nevados de Chillan), and 6) transient deflation due to extraction of magmatic fluids triggered by the 2010 Maule earthquake ([Reath et al., 2019](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2018JB016199), Pritchard et al., 2013).
