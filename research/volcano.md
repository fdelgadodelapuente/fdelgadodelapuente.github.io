...
InSAR and GNSS time series of ground deformation for selected volcanoes in the Southern Andes spanning more than three decades. Panels A-D are taken from [Delgado et al., (2025)](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2025JB032010), and for Chaitén I also include an additional SAOCOM-1 interferogram spanning 2022/11 to 2025/11. Data in E are taken from  [Navarrete et al., (2026)](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2025GL120184). Data in F includes a GNSS baseline time series from the OVDAS network processed by CSN, and ENVISAT/ALOS from [Delgado et al., (2017)](https://www.sciencedirect.com/science/article/pii/S0377027317303086). These InSAR data are very low quality and do not show clear deformation, so I only highlight the time interval they span. Data in G are from Symmes et al., (to be submitted paper to review in April 2026). It also includes some ENVISAT and ALOS data that I have processed over the years. Data in H are compiled from Velez et al., (2011); Lundgren et al., (2017); [Reath et al., 2019](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2018JB016199) and [Cabrera et al., (2024)](https://pubs.geoscienceworld.org/ssa/srl/article/doi/10.1785/0220240022/644475/Eruption-Forecasting-Model-for-Copahue-Volcano). Color bars indicate eruptions: sub Plinian / Plinian (dashed red), effusive phase and rhyolitic dome/lava effusion (continuous red), VEI 1-2 (dashed pink), long lasting phases of small magnitude intermitent activity (continuous pink) and the Mw 8.8 2010 megathrust Maule earthquake (blue). I do not include data from Llaima and Peteroa volcanoes that erupted in the same time span due to the poor quality of the InSAR data ([Reath et al., 2019](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2018JB016199), [Romero et al., 2020](https://www.sciencedirect.com/science/article/abs/pii/S0377027320300913)) and lack of detection of ground deformation by the sparse GNSS networks in these two volcanoes. 

The compilation shows six different mechanisms of ground deformation. These are: 1) co-eruptive deflation during Plinian/sub-Plinian eruptions (Chaiten, Cordon Caulle, Calbuco), 2) continuous inflation due to magma injection and/or viscoelastic relaxation after Plinian/sub-Plinian eruptions (Hudson, Cordon Caulle), 3) near continuous injection of magma (Laguna del Maule), 4) an episode of trasient, short-lived uplift due to magma injection after the 2015 VEI 2 eruption of Villarrica volcano, 5) secular deflation due to hydrothermal activity/intrusion crystallization interrupted by transient episodes of magma injection lasting 2.5-8 years (Copahue and Nevados de Chillan), and 6) transient deflation due to extraction of magmatic fluids triggered by the 2010 Maule earthquake (Copahue and Nevados de Chillan, Pritchard et al., 2013).



<img style="float: center;" src="/images/saocom_aniakchak.jpeg" width="700">

Episode of unrest at Aniakchak Crater in Alaska during early 2023, with a LOS uplift of ~80 cm in less than one year (A) followed by ground deflation with a rate of -7 cm/yr (B). Panel (E) shows a time series for the pxiel of the same color in (A-B). This is the fastest deformation event I have detected ever with InSAR (Updated from [Delgado et al., 2024.](https://ieeexplore.ieee.org/document/10586971), [Delgado, 2026.](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2025GL117786) )<br>.

<!-- <img style="float: center;" src="/images/ts2012_2024_dsc_asc.png" width="700"> -->
<img style="float: center;" src="/images/ts2012_2026.png" width="700">
...
[The triggering of sub-Plinian and Plinian eruptions: insights from three decades of InSAR observations in the Andean Southern Volcanic Zone (1991-2025) and a global compilation.](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2025JB032010)<br>
