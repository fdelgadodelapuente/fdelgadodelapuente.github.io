...
The compilation shows a variety of deformation mechanisms including, 1) secular deflation due to hydrothermal activity interrupted by transient episodes of magma injection lasting 2.5-8 years (Copahue and Nevados de Chillan), 2) co-eruptive deflation during eruptions (Chaiten, Cordon Caulle, Calbuco), 3) continuous inflation due to magma injection and/or viscoelastic relaxation after Plinian/sub-Plinian eruptions (Hudson, Cordon Caulle), 4) near continuous injection of magma (Laguna del Maule) and 5) an episode of trasient uplift after the 2015 VEI 2 eruption of Villarrica volcano.
