...
<img style="float: center;" src="/images/ts2012_2022_dsc_asc.png" width="500">

Time series of uplift at Cordon Caulle volcano measured by Sentinel-1, COSMO-SkyMED, RADARSAT-2 and ALOS-2 ascending (asc) and descending (dsc) data after its 2011-2012 eruption (vertical black dashed line). The brown dots show the horizontal baseline change between two GPS stations in the volcano. The black line shows an exponential fit to the COSMO-SkyMED data and is strong evidence for a mechanism of magma injection in a shallow pressurized reservoir. Magma injection is likely responsible for the four pulses of ground uplift, although other mechanisms like poroelastic mush extraction cannot be ruled out.
